...
<body>
    <div class="h-screen justify-center-safe place-items-center grid font-['Jersey10']">
        <div id="header" class="grid justify-center place-items-center sm:mt-[5%] mt-[20%] sm:mb-[11%] mb-64">
            ...
            <h3 class="lg:text-9xl sm:text-7xl sm:mt-3 text-6xl text-center">500 Server Error</h3>
            <h3 class="sm:text-3xl text-2xl m-5 text-pretty">It looks like the server encountered an unexpected condition and could not fulfill your request.</h3>
